...
const BASE_URL = GetEnvVariable("VITE_API_BASE_URL", "https://localhost/api/v1/"); // base url is mainly for if their is a gateway being used , if not then the individual urls fro each service will have to be used
