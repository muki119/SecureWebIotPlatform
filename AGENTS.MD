...
- **Commits & Pull Request Titles**:
  ...
  - Allowed types: `feat`, `fix`, `perf`, `refactor`, `docs`, `test`, `build`, `ci`, `chore`, `revert`. Scope is optional; when used it's the affected area: `authentication`, `domain`, `devicecontrol`, `ledger`, `eventbus`, `common`, `app`, `demo`, `release`.
