...
export const STREAMS = {
	// streams instead of actions because certain services only need to listen to certain streams
	AUTH_SERVICE: {
		USER_CREATED: "AUTH_SERVICE.USER_CREATED",
		USER_DELETED: "AUTH_SERVICE.USER_DELETED",
		USER_UPDATED: "AUTH_SERVICE.USER_UPDATED",
		PASSWORD_RESET_REQUESTED: "AUTH_SERVICE.PASSWORD_RESET_REQUESTED",
	},
	DOMAIN_SERVICE: {
