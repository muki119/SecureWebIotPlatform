...
export interface IDevice extends ModelSchema {
    ...
    currentState: Map<string, CurrentDeviceState> | Record<string, CurrentDeviceState>,
    capabilities: Map<string, DeviceCapabilities> | Record<string, DeviceCapabilities>
}
