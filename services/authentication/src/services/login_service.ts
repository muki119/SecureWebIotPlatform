...
export default async function LoginService(email: string, password: string): Promise<string | null> { // should really just return the uuid -- beacuse the users infomation will be pulled on another route lke a /me
    try {
